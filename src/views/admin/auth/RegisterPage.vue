    ...
    <div class="h-screen overflow-auto w-full aside-scrollbars-light">
      <div class="flex px-2 flex-col justify-center self-stretch min-h-screen">
        <div class="flex max-w-[100%] w-[360px] flex-col items-start mx-auto my-6">
          ...
          <!-- Header and form -->
          <h1 class="font-primary text-[22px] font-bold leading-5 pb-3">Register</h1>
          <p class="text-[#475467] font-primary text-[14px] font-semibold leading-5 pb-8">
            Welcome back! Please enter your details.
          </p>
          <p class="text-[#475467] font-primary text-[14px] font-medium leading-5 pb-1.5">
            First Name*
          </p>
          <input
            type="text"
          ...
          <div class="flex items-center self-stretch">
            <div class="flex items-start justify-between w-full">
              <div class="flex items-center my-6">
                ...
                >
                  accept terms & condition and
                  <span class="text-[#E24949] pl-1">privacy policy</span>
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <router-link to="/login">
              <span class="text-[#E24949] pl-1"> Sign in </span>
            </router-link>
          </p>
        </div>
      </div>
