      ...
      <div class="flex px-2 flex-col justify-center self-stretch min-h-screen">
        <div class="flex max-w-[100%] w-[360px] flex-col items-start mx-auto my-6">
          ...
          <div class="mx-auto flex flex-col items-center justify-center">
            ...
            <p class="text-[#475467] font-primary text-[16px] font-normal leading-5 pb-8">
              No worries, we’ll send you reset instructions.
            </p>
          </div>
          <p class="text-[#475467] font-primary text-[16px] leading-5 pb-1.5 pt-5">
            Email
          </p>
          <input
            type="email"
